...
def make_question(qid, qtype, dimension, text, options, reveal):
    return {
        "id": qid,
        "type": qtype,
        "dimension": dimension,
...
questions.append(make_question(
    "liubian_sweet_1", "sweet", ["S2", "S8"],
    "劉辯突然湊近你，手指繞著自己的髮梢，問你喜歡直髮還是卷髮。",
    [
        {
            "label": "A",
    ...
    "劉辯台詞：「我来问，广陵王是喜欢直发，还是喜欢卷发？」（夕情欢馀·刘辩/活动剧情）"
))

# 2
questions.append(make_question(
    "liubian_sweet_2", "sweet", ["S2", "S5"],
    "劉辯抓起你的手貼在自己臉側，說他的頭髮比綢緞還順滑，讓你摸摸看。",
    [
        {
            "label": "A",
    ...
    "劉辯台詞：「我的头发也很好打理，你摸，肯定比绸缎还要顺滑。」（夕情欢馀·刘辩/活动剧情）"
))

# 3
questions.append(make_question(
    "liubian_sweet_3", "sweet", ["S2", "S4"],
    "劉辯湊近你頸邊輕嗅，然後抬頭問你覺得他是什麼味道。",
    [
        {
            "label": "A",
            "text": "說「降真香的煙火氣」。",
    ...
    "劉辯台詞：「你呢，觉得我是什么味道？」（夕情欢馀·刘辩/活动剧情）"
))

# 4
questions.append(make_question(
    "liubian_sweet_4", "sweet", ["S2", "S8"],
    "劉辯突然抱住你，在你耳邊低聲說「我就知道，我的廣陵王肯定喜歡我」。",
    [
        {
            "label": "A",
            "text": "回抱他，輕聲說「嗯」。",
    ...
    "劉辯台詞：「我就知道，我的广陵王肯定喜欢我……」（夕情欢馀·刘辩/活动剧情）"
))

# 5
questions.append(make_question(
    "liubian_sweet_5", "sweet", ["S2", "S9"],
    "劉辯捧著你的臉，認真地說「我的真愛可是無價之寶」。",
    [
        {
            "label": "A",
            "text": "笑著說「那我也用無價之寶換」。",
    ...
    "劉辯台詞：「我的真爱可是无价之宝。」（夕情欢馀·刘辩/活动剧情）"
))

# ================== FUNNY 批次 ==================
# 6
questions.append(make_question(
    "liubian_funny_1", "funny", ["S4", "S7"],
    "劉辯得意地說他創立了五斗咪道，問你要不要加入。",
    [
        {
            "label": "A",
            "text": "一本正經地說「加入有什麼好處？」。",
    ...
    "劉辯台詞：「加入五斗咪，什么都会有的。」（咪教模拟器/活动剧情）"
))

# 7
questions.append(make_question(
    "liubian_funny_2", "funny", ["S3", "S7"],
    "劉辯說「真經上寫了，愛哭的男人最好命」，然後眼巴巴看著你。",
    [
        {
            "label": "A",
            "text": "點頭說「對，你最好命」。",
    ...
    "劉辯台詞：「真经上写了，爱哭的男人最好命。」（夕情欢馀·刘辩/活动剧情）"
))

# 8
questions.append(make_question(
    "liubian_funny_3", "funny", ["S5", "S8"],
    "劉辯衣服被口水弄濕，大喊「我要換衣服！黏糊糊的！！」。",
    [
        {
            "label": "A",
            "text": "幫他找乾淨衣服，說「快換上」。",
    ...
    "劉辯台詞：「我要换衣服！黏糊糊的！！」（咪教模拟器/活动剧情）"
))

# 9
questions.append(make_question(
    "liubian_funny_4", "funny", ["S4", "S6"],
    "劉辯說「小酒坛子的存钱罐里捞出来的」，把錢給你。",
    [
        {
            "label": "A",
            "text": "收下錢，說「謝謝小酒坛子」。",
    ...
    "劉辯台詞：「小酒坛子的存钱罐里捞出来的。」（夕情欢馀·刘辩/活动剧情）"
))

# 10
questions.append(make_question(
    "liubian_funny_5", "funny", ["S3", "S5"],
    "劉辯說「燒起來了！快幫我！」，道袍袖口著火。",
    [
        {
            "label": "A",
    ...
    "劉辯台詞：「烧起来了！快帮我！」（夕情欢馀·刘辩/活动剧情）"
))

# ================== ANGST 批次 ==================
# 11
questions.append(make_question(
    "liubian_angst_1", "angst", ["S2", "S9"],
    "劉辯握著你的手，輕聲說「我一直想和你死在一起」。",
    [
        {
            "label": "A",
            "text": "握緊他的手，說「好」。",
    ...
    "劉辯台詞：「我一直想和你死在一起。」（夕情欢馀·刘辩/活动剧情）"
))

# 12
questions.append(make_question(
    "liubian_angst_2", "angst", ["S6", "S2"],
    "劉辯說「愛是什麼輕飄飄的東西。能實實在在握在手中的東西，只有一起去死」。",
    [
        {
            "label": "A",
            "text": "抱住他，說「我就在這裡」。",
    ...
    "劉辯台詞：「爱？爱是什么轻飘飘的东西。能实实在在握在手中的东西，只有一起去死。」（夕情欢馀·刘辩/活动剧情）"
))

# 13
questions.append(make_question(
    "liubian_angst_3", "angst", ["S2", "S10"],
    "劉辯說「時間已經一點意義都沒有了」，眼神空洞。",
    [
        {
            "label": "A",
    ...
    "劉辯台詞：「时间已经一点意义都没有了。」（夕情欢馀·刘辩/活动剧情）"
))

# 14
questions.append(make_question(
    "liubian_angst_4", "angst", ["S9", "S8"],
    "劉辯問「你想穿什麼衣服一起死？」",
    [
        {
            "label": "A",
    ...
    "劉辯台詞：「我想问……我们一起死去之时，你想穿什么衣服？」（夕情欢馀·刘辩/活动剧情）"
))

# 15
questions.append(make_question(
    "liubian_angst_5", "angst", ["S6", "S5"],
    "劉辯說「你為什麼不來……我恨你……」，聲音哽咽。",
    [
        {
            "label": "A",
    ...
    "劉辯台詞：「你為什麼不來……我恨你……」（咪教模拟器/活动剧情/普通线）"
))

# ================== SCHEME 批次 ==================
# 16
questions.append(make_question(
    "liubian_scheme_1", "scheme", ["S1", "S6"],
    "劉辯提議趁張修不在，把鬼城據為己有，問你合作否。",
    [
        {
            "label": "A",
            "text": "同意，說「需要我做什麼？」",
    ...
    "劉辯台詞：「趁着张修不在，让我们把此地据为己有吧！咪教，成……」（咪教模拟器/活动剧情）"
))

# 17
questions.append(make_question(
    "liubian_scheme_2", "scheme", ["S9", "S10"],
    "劉辯說「我們五斗咪道全城放糧！只要依附於我，就能免於飢苦！」",
    [
        {
            "label": "A",
            "text": "幫忙組織放糧，擴大影響。",
    ...
    "劉辯台詞：「今天，我们五斗咪道全城放粮！张修已经不会回来了，但只要依附于我，就能免于饥苦！」（咪教模拟器/活动剧情/龙女线）"
))

# 18
questions.append(make_question(
    "liubian_scheme_3", "scheme", ["S1", "S4"],
    "劉辯說「我們挑一個對象，把一切推到他身上，如何？」",
    [
        {
            "label": "A",
            "text": "贊成，說「選誰？」",
    ...
    "劉辯台詞：「我知道了……那，既然广陵王愿意联手，我也不介意冰释前嫌。这样，我们挑一个对象，把一切推到他身上，如何？」（咪教模拟器/活动剧情/龙女线）"
))

# 19
questions.append(make_question(
    "liubian_scheme_4", "scheme", ["S6", "S9"],
    "劉辯抓到騙子，問你「你說，怎麼處置這個騙子？」",
    [
        {
            "label": "A",
            "text": "說「交給官府」。",
    ...
    "劉辯台詞：「你说，怎么处置这个骗子？」（咪教模拟器/活动剧情）"
))

# 20
questions.append(make_question(
    "liubian_scheme_5", "scheme", ["S1", "S3"],
    "劉辯說「廣陵王，我們隨身的錢不多了」，暗示需要籌錢。",
    [
        {
            "label": "A",
            "text": "提議「去騙富戶」。",
    ...
    "劉辯台詞：「广陵王，我们随身的钱不多了。」（咪教模拟器/活动剧情/粮草线）"
))

# ================== DAILY 批次 ==================
# 21
questions.append(make_question(
    "liubian_daily_1", "daily", ["S3", "S8"],
    "劉辯說「養他們這麼費錢，把他們全遣散，只留下小道嘛」。",
    [
        {
            "label": "A",
            "text": "說「好，只留你」。",
    ...
    "劉辯台詞：「养他们这么费钱，把他们全遣散，只留下小道嘛。」（夕情欢馀·刘辩/活动剧情）"
))

# 22
questions.append(make_question(
    "liubian_daily_2", "daily", ["S5", "S10"],
    "劉辯喝酒後對著心紙君說話，被你撞見。",
    [
        {
            "label": "A",
    ...
    "劉辯台詞：「喝酒呀，一个人去蒹葭滩上、雪地里、地宫里……一直对着你的心纸君说话，直到你回覆我。」（夕情欢馀·刘辩/活动剧情）"
))

# 23
questions.append(make_question(
    "liubian_daily_3", "daily", ["S2", "S3"],
    "劉辯問「你的錢一般都花去哪了？」",
    [
        {
            "label": "A",
    ...
    "劉辯台詞：「换、换我问！你的钱一般都花去哪了？」（夕情欢馀·刘辩/活动剧情）"
))

# 24
questions.append(make_question(
    "liubian_daily_4", "daily", ["S8", "S9"],
    "劉辯說「我們一家三口齊齊整整」，指你、他和小酒坛子。",
    [
        {
            "label": "A",
            "text": "笑著說「對，一家三口」。",
    ...
    "劉辯台詞：「让小酒坛子封穴前跳进来，小酒坛子变成小土坛子，我们一家三口齐齐整整。」（夕情欢馀·刘辩/活动剧情）"
))

# 25
questions.append(make_question(
    "liubian_daily_5", "daily", ["S4", "S7"],
    "劉辯說「上班哪有那麼恐怖，好像天都要塌了似的。沒有班上才恐怖吧？」",
    [
        {
            "label": "A",
            "text": "點頭說「你說得對」。",
    ...
    "劉辯台詞：「上班哪有那么恐怖，好像天都要塌了似的。没有班上才恐怖吧？」（夕情欢馀·刘辩/活动剧情）"
))

# ================== CLASSIC 批次 ==================
# 26
questions.append(make_question(
    "liubian_classic_1", "classic", ["S6", "S10"],
    "劉辯在隱鳶閣把渾儀推亂，所有人都觀不到星，他問你怎麼辦。",
    [
        {
            "label": "A",
            "text": "說「我去修」。",
    ...
    "劉辯台詞：「呃……好早以前，我把隐鸢阁观星台浑仪推乱了，所有人都观不到橙星。」（夕情欢馀·刘辩/活动剧情）"
))

# 27
questions.append(make_question(
    "liubian_classic_2", "classic", ["S2", "S5"],
    "劉辯在畫廊裡說「你說謊了，回廊一直延伸不讓我們出去」。",
    [
        {
            "label": "A",
            "text": "承認「我說謊了」。",
    ...
    "劉辯台詞：「你看，画里的回廊一直延伸，不让我们出去，说明你说谎了。」（夕情欢馀·刘辩/活动剧情）"
))

# 28
questions.append(make_question(
    "liubian_classic_3", "classic", ["S1", "S9"],
    "劉辯在咪教模擬器中傳道，問你覺得他的教義如何。",
    [
        {
            "label": "A",
            "text": "稱讚「很有吸引力」。",
    ...
    "劉辯台詞：「不要小看我的魅力，我往这一坐，立刻就有人前仆后继来投。」（咪教模拟器/活动剧情）"
))

# 29
questions.append(make_question(
    "liubian_classic_4", "classic", ["S3", "S8"],
    "劉辯說「我為你流下的都是真情實感的眼淚」。",
    [
        {
            "label": "A",
    ...
    "劉辯台詞：「我为你流下的都是真情实感的眼泪。」（夕情欢馀·刘辩/活动剧情）"
))

# 30
questions.append(make_question(
    "liubian_classic_5", "classic", ["S4", "S6"],
    "劉辯說「我雖然對錢沒什麼感覺，但也覺得這個數有點過分了。廣陵王，要信他嗎？」",
    [
        {
            "label": "A",
            "text": "說「不信，我們走」。",
    ...
    "劉辯台詞：「……我虽然对钱没什么感觉，但也觉得这个数有点过分了。广陵王，要信他吗？」（咪教模拟器/活动剧情）"
))
